...
class TestIIIFPresentation:
    ...
    def test_from_url(self):
        ...
        with patch("piffle.presentation.requests") as mockrequests:
            ...
            with pytest.raises(
                IIIFException, match="Error retrieving manifest .* 403 Forbidden"
            ):
            ...
            with pytest.raises(IIIFException, match="No JSON found"):
                mockresponse.status_code = requests.codes.ok
            ...
            # json parsing error
            with pytest.raises(IIIFException, match="Error parsing JSON"):
    ...
    def test_from_url_or_file(self):
        with patch.object(IIIFPresentation, "from_url") as mock_from_url:
            ...
            with pytest.raises(IIIFException, match="File not found: "):
